...
@section('content')
    ...
    <div data-elementor-type="wp-page" data-elementor-id="470" class="elementor elementor-470">
        <div class="elementor-element elementor-element-c0a2470 e-con-full e-flex e-con e-parent" data-id="c0a2470"
            data-element_type="container">
            <div class="elementor-element elementor-element-0fa4e9b elementor-widget elementor-widget-carit-google-maps"
                data-id="0fa4e9b" data-element_type="widget" data-widget_type="carit-google-maps.default">
                <div class="elementor-widget-container">
                    ...
                    <section class="contact-top section-space">
                        <div class="container">
                            <div class="contact-top__inner">
                                <div class="contact-top__item wow fadeInUp" data-wow-duration='1500ms'
                                    ...
                                    <div class="contact-top__item__icon">
                                        <i aria-hidden="true" class="icon-call-2"></i>
                                ...
                                <div class="contact-top__item wow fadeInUp" data-wow-duration='1500ms'
                                    data-wow-delay='100ms'>
                                    <div class="contact-top__item__icon">
                                        <i aria-hidden="true" class=" icon-group-5"></i>
                                    </div><!-- /.contact-top__item__icon -->
                                    <div class="contact-top__item__content">
                                        <span class="contact-top__item__title">Contact
                                ...
                                <div class="contact-top__item wow fadeInUp" data-wow-duration='1500ms'
                                    data-wow-delay='100ms'>
                                    <div class="contact-top__item__icon">
                                        <i aria-hidden="true" class=" icon-clock-five"></i>
                                    </div><!-- /.contact-top__item__icon -->
                                    <div class="contact-top__item__content">
                                ...
                                <div class="contact-top__item wow fadeInUp" data-wow-duration='1500ms'
                                    data-wow-delay='100ms'>
                                    <div class="contact-top__item__icon">
                                        <i aria-hidden="true" class=" icon-comment-alt-dots"></i>
                                    </div><!-- /.contact-top__item__icon -->
                                    <div class="contact-top__item__content">
                                        <span class="contact-top__item__title">Contact
                            ...
                            <div class="contact-top__maps wow fadeInUp" data-wow-duration='1500ms'
                                data-wow-delay='100ms'>
                                <div class="google-map google-map__google-map">
                                    <iframe title="template google map"
                                        src="https://maps.google.com/maps?q=Costco%20Wholesale&#038;t=m&#038;z=17&#038;output=embed&#038;iwloc=near"
                                        class="map__google-map" allowfullscreen></iframe>
                                </div>
                                <!-- /.google-map -->
                            </div><!-- /.contact-top__maps -->
                        </div><!-- /.container -->
                    </section><!-- /.contact-top -->
        ...
        <div class="elementor-element elementor-element-dc0d9e1 e-con-full e-flex e-con e-parent" data-id="dc0d9e1"
            data-element_type="container">
            <div class="elementor-element elementor-element-ac3961f elementor-widget elementor-widget-carit-contact"
                data-id="ac3961f" data-element_type="widget" data-widget_type="carit-contact.default">
                <div class="elementor-widget-container">

                    <section class="contact-massage">
                        <div class="container">
                            <div class="row align-items-center gutter-y-30">
                                <div class="col-lg-6">
                                    <div class="contact-massage__thumb wow fadeInLeft" data-wow-duration='1500ms'
                                        data-wow-delay='100ms'>
                                        <img decoding="async"
                                            src="https://caritwp.bracketweb.com/wp-content/uploads/2025/11/contact-1-1.jpg"
                                            alt="contact-1-1" title="contact-1-1">
                                    </div><!-- /.contact-massage__thumb -->
                                </div><!-- /.col-lg-6 -->
                                <div class="col-lg-6">
                                        ...
                                        <div class="wpcf7 no-js" id="wpcf7-f484-p470-o1" lang="en-US" dir="ltr"
                                            ...
                                            <form action="{{ route('contact.submit') }}" method="POST"
                                                ...
                                                <div class="form-one__group">
                                                    ...
                                                    <div class="form-one__control form-one__control--full">
                                                        <p class="form-one__text"><span>* </span>Call us 24/7 or fill out
                    ...
                    </section><!-- /.contact-massage -->

                </div>
            </div>
        </div>
        <div class="elementor-element elementor-element-23a48f6 e-con-full e-flex e-con e-parent" data-id="23a48f6"
            data-element_type="container">
            <div class="elementor-element elementor-element-f2c5530 elementor-widget elementor-widget-carit-client"
                data-id="f2c5530" data-element_type="widget" data-widget_type="carit-client.default">
                <div class="elementor-widget-container">
