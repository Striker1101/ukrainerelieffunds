                    ...
                    <section class="main-slider-one" id="home">
                        <div class="main-slider-one__carousel carit-owl__carousel owl-carousel"
                            ...
                            <div class="item">
                                <div class="main-slider-one__item">
                                    <div class="main-slider-one__bg"
                                        style="background-image: url({{ asset('images/hero-3-1.jpg') }});">
                                    </div><!-- /.main-slider-one__bg -->
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-xl-7">
                                                <div class="main-slider-one__content">
                                                    <h5 class="main-slider-one__tagline"> <i aria-hidden="true"
                                                            class="icon-love-safe"></i> Stand With Those in Need</h5>
                                                    <h2 class="main-slider-one__title">Small Efforts Create Big Change</h2>
                                                    <!-- /.main-slider-one__title -->
                                                    <p class="main-slider-one__text">Consistent acts of kindness build
                                                        lasting impact. What seems small today can become life-changing when
                                                        combined with collective support.
                                                        We carry out outreach programs across different regions of the
                                                        world, delivering aid, education, and emotional support to people
                                                        affected by conflict, poverty, and disaster.
                                                        When crisis strikes, standing together becomes a powerful act. Your
                                                        support helps us reach forgotten communities and respond when help
                                                        is needed most.
                                                    </p>
                                                    <!-- /.main-slider-one__text -->
                                                    <div class="main-slider-one__btn">
                                                    ...
                                                    {{-- <div class="main-slider-one__arrow">
                                                        <img decoding="async" src="{{ asset('images/faq-1-1.jpg') }}"
                                                            alt="hero-arrow-1-1" title="hero-arrow-1-1">
                                                    </div><!-- /.main-slider-one__arrow --> --}}
                                                </div><!-- /.main-slider-one__content -->
                                            </div><!-- /.col-xl-6 -->
                                            <div class="col-xl-5">
                                                <div class="main-slider-one__image">
                                                    <img decoding="async" src="{{ asset('images/hero-3-2.png') }}"
                                                        alt="hero-image-1-1" title="hero-image-1-1">
                                                </div><!-- /.main-slider-one__image -->
                                            </div><!-- /.col-xl-6 -->
                                        </div><!-- /.row -->
                            ...
                            <div class="item">
                                <div class="main-slider-one__item">
                                    <div class="main-slider-one__bg"
                                        style="background-image: url({{ asset('images/uk1.jpeg') }});">
                                    </div><!-- /.main-slider-one__bg -->
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-xl-7">
                                                <div class="main-slider-one__content">
                                                    <h5 class="main-slider-one__tagline"> <i aria-hidden="true"
                                                            class="icon-love-safe"></i> Be a Source of Hope</h5>
                                                    <h2 class="main-slider-one__title">Every Action
                                                        Matters</h2><!-- /.main-slider-one__title -->
                                                    <p class="main-slider-one__text">Hope begins when someone chooses
                                                        to care. By taking action, you become part of a movement that
                                                        restores strength and dignity to vulnerable lives.
                                                        True change is not built overnight. Through steady commitment
                                                        and shared responsibility, we create meaningful progress that
                                                        lasts.
                                                        Our mission extends beyond borders. We work across nations to
                                                        uplift communities, provide essential services, and inspire
                                                    ...
                                                    <div class="main-slider-one__arrow">
                                                        {{-- <img decoding="async"
                                                            src="{{ asset('images/hero-image-1-1.png') }}"
                                                            alt="hero-arrow-1-1" title="hero-arrow-1-1"> --}}
                                                    </div><!-- /.main-slider-one__arrow -->
                                                </div><!-- /.main-slider-one__content -->
                                            </div><!-- /.col-xl-6 -->
                                            <div class="col-xl-5">
                                                <div class="main-slider-one__image">
                                                    <img decoding="async" src="{{ asset('images/hero-image-1-1.png') }}"
                                                        alt="hero-image-1-1" title="hero-image-1-1" />
                                                </div><!-- /.main-slider-one__image -->
                                            </div><!-- /.col-xl-6 -->
                                        </div><!-- /.row -->
                            ...
                            <div class="row gutter-x-24">
                                    ...
                                    <div class="feature-one__item wow fadeInUp" data-wow-duration='1500ms'
                                        ...
                                        <div class="feature-one__item__content">
                                            <h3 class="feature-one__item__title"><a
                                                    href="{{ route('donation') }}">Infastructure</a>
                                            </h3><!-- /.feature-one__item__title -->
                                            <p class="feature-one__item__text">Provide Food and Daily neccessity
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6">
                                    <div class="feature-one__item active wow fadeInUp" data-wow-duration='1500ms'
                                        ...
                                        <div class="feature-one__item__content">
                                            <h3 class="feature-one__item__title"><a
                                                    href="{{ route('donation') }}">Healthcare</a>
                                            </h3><!-- /.feature-one__item__title -->
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6">
                                    <div class="feature-one__item wow fadeInUp" data-wow-duration='1500ms'
                                        ...
                                        <div class="feature-one__item__content">
                                            <h3 class="feature-one__item__title"><a
                                                    href="{{ route('donation') }}">Humanitarian
                                                    Service</a>
                                            </h3><!-- /.feature-one__item__title -->
                                            <p class="feature-one__item__text">Enlist Aids For Search and Rescue
                                            </p><!-- /.feature-one__item__text -->
                                        </div><!-- /.feature-one__item__content -->
                                    </div><!-- /.feature-one__item -->
                                </div><!-- /.col-xl-3 -->
                                    ...
                                    <div class="feature-one__item feature-one__item--two wow fadeInUp"
                                        ...
                                        <div class="feature-one__item__bottom">
                                            <div class="feature-one__item__left">
                                                ...
                                                <a href="mailto:info@carit.com">{{ config('custom.email') }}</a>
                                            </div><!-- /.feature-one__item__left -->
                                            <div class="feature-one__item__btn">
                                                <a href="{{ route('donation') }}"><i aria-hidden="true"
                    ...
                    <div class="donations-one section-space-top">
                        <div class="container">
                            <div class="donations-one__top">
                                ...
                                <p class="donations-one__top__text bw-text bw-split-in-down">
                                    Through your generosity, you become the hero in someone’s story, turning despair into
                                    possibility.
                                </p>
                                        ...
                                        <div class="donation-card wow fadeInUp" data-wow-duration='1500ms'
                                            ...
                                            <div class="donation-card__thumb">
                                                <img fetchpriority="high" decoding="async" width="416" height="300"
                                                    src="{{ asset('images/' . $donation['image']) }}"
                                                    class="attachment-carit_blog_416X300 size-carit_blog_416X300 wp-post-image"
                                                    alt="{{ $donation['title'] }}" /> <a
                                                    href="{{ route('donation_detail', $donation['id']) }}"
                                            ...
                                            <div class="donation-card__content">
                                                <div class="donation-card__count-bar count-box">
                                                    <h3 class="donation-card__funfact">
                                                        <span class="count-text" data-stop="{{ $percent }}"
                                        ...
                                        "fill": {
                                            "color": "#FFE400"
                                                ...
                                                <h4 class="donation-card__title"><a
                                                        href="{{ route('donation_detail', $donation['id']) }}">
                                                        {{ $donation['title'] }}</a></h4><!-- /.donation-card__title -->
                                                <div class="progress-box">
                                                    <div class="progress-box__bar">
                                                        <div class="progress-box__bar__inner count-bar"
                                                    ...
                                                    <div class="progress-box__content">
                                                        <p class="progress-box__text">Donated
                                                            :<span>&#036;{{ $donation['donation'] }}</span></p>
                                                        <!-- /.progress-box__text -->
                                                        <p class="progress-box__text">Goal
                                                            :<span>&#036;{{ $donation['goal'] }}</span></p>
                                                        <!-- /.progress-box__text -->
                                                    </div><!-- /.progress-box__content -->
                                                </div><!-- /.progress-box -->
                                                <div class="donation-card__btn">
                                                    <a href="{{ route('donation_detail', $donation['id']) }}"
                                ...
                                <div class="row align-items-end gutter-y-24">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="team-two__right">
                                            <p class="team-two__text">Giving is not just charity—it is the bravery to stand
                                                for someone else’s tomorrow.</p>
                                            <!-- /.team-two__text -->
