...
@section('content')
        ...
        <div class="container">
            ...
            <ul class="carit-breadcrumb list-unstyled">
                ...
                <li class="post post-page current-item"><span property="itemListElement" typeof="ListItem"><span
                            property="name" class="post post-page current-item">Faqs Page</span>
    ...
    <div data-elementor-type="wp-page" data-elementor-id="671" class="elementor elementor-671">
        <div class="elementor-element elementor-element-aea4614 e-con-full e-flex e-con e-parent" data-id="aea4614"
            data-element_type="container">
            <div class="elementor-element elementor-element-80f4a9a elementor-widget elementor-widget-carit-faq"
                data-id="80f4a9a" data-element_type="widget" data-widget_type="carit-faq.default">
                <div class="elementor-widget-container">

                    <section class="faq-section section-space-top" id="faq">
                        <div class="container">
                            <div class="row gutter-y-30">
                                <div class="col-lg-6">
                                    <div class="faq-page__title">
                                        <h6 class="faq-page__title__subtitle title">
                                            Faq </h6>
                                        <h3 class="faq-page__title__title title bw-split-in-up">
                                            Frequency &amp; Questions </h3>
                                        <p class="faq-page__title__text bw-split-in-up">Donations help support our mission
                                            and directly impact individuals and communities in need. Every contribution, big
                                            or small, is used responsibly to fund programs, provide resources, and create
                                            lasting positive change.</p>
                                    </div><!-- /.faq-page__title -->
                                    <div class="faq-accordion carit-accrodion" data-grp-name="carit-accrodion">
                                        <div class="accordion active wow fadeInUp" data-wow-duration='1500ms'
                                            data-wow-delay='500ms'>
                                            <div class="accordion-title">
                                                <h4 class="accordion-title__text">
                                                    Can I choose a specific cause to donate to?<span
                                                        class="accordion-title__icon"></span>
                                                </h4>
                                            </div><!-- /.accordian-title -->
                                            <div class="accordion-content">
                                                <div class="inner">
                                                    <p class="inner__text">Yes, you can select a specific project or cause
                                                        during the donation process.
                                                        This ensures your contribution supports what matters most to you.
                                                        If no option is selected, funds go where they are most needed.
                                                    </p>
                                        ...
                                        <div class="accordion wow fadeInUp" data-wow-duration='1500ms'
                                            ...
                                            <div class="accordion-title">
                                                <h4 class="accordion-title__text">
                                                    How will my donation be used?<span
                                                        class="accordion-title__icon"></span>
                                                </h4>
                                            </div><!-- /.accordian-title -->
                                            <div class="accordion-content">
                                                <div class="inner">
                                                    <p class="inner__text">Your donation goes directly toward funding
                                                        projects, services, and initiatives that support our cause and
                                                        beneficiaries.
                                                    </p>
                                                </div><!-- /.accordian-content -->
                                            </div>
                                        ...
                                        <div class="accordion wow fadeInUp" data-wow-duration='1500ms'
                                            ...
                                            <div class="accordion-title">
                                                <h4 class="accordion-title__text">
                                                    Is my donation secure?<span class="accordion-title__icon"></span>
                                                </h4>
                                            </div><!-- /.accordian-title -->
                                            <div class="accordion-content">
                                                <div class="inner">
                                                    <p class="inner__text">
                                                        Yes. We use trusted and secure payment systems to protect your
                                        ...
                                        <div class="accordion wow fadeInUp" data-wow-duration='1500ms'
                                            ...
                                            <div class="accordion-title">
                                                <h4 class="accordion-title__text">
                                                    Can I make a recurring donation?<span
                                                        class="accordion-title__icon"></span>
                                                </h4>
                                            </div><!-- /.accordian-title -->
                                            <div class="accordion-content">
                                                <div class="inner">
                                                    <p class="inner__text">Yes, you can choose to donate monthly or at any
                                        ...
                                        <div class="accordion wow fadeInUp" data-wow-duration='1500ms'
                                            ...
                                            <div class="accordion-title">
                                                <h4 class="accordion-title__text">
                                                    Will I receive a receipt for my donation?<span
                                                        class="accordion-title__icon"></span>
                                                </h4>
                                            </div><!-- /.accordian-title -->
                                            <div class="accordion-content">
                                                <div class="inner">
                                                    <p class="inner__text">Absolutely. A confirmation and receipt will be
                                                        sent to your email after every successful donation.
                                                    </p>
                                                </div><!-- /.accordian-content -->
                                            </div>
                                        </div><!-- /.accordian-item -->
                                        ...
                                        <div class="accordion wow fadeInUp" data-wow-duration='1500ms'
                                            ...
                                            <div class="accordion-title">
                                                <h4 class="accordion-title__text">
                                                    Can I donate on behalf of someone else or in memory of someone?<span
                                                        class="accordion-title__icon"></span>
                                                </h4>
                                            </div><!-- /.accordian-title -->
                                            <div class="accordion-content">
                                                <div class="inner">
                                                    <p class="inner__text">Yes, you can make donations in honor or in
                                ...
                                <div class="col-lg-6">
                                    <div class="faq-section__thumb">
                                        <img decoding="async"
                                            src="https://caritwp.bracketweb.com/wp-content/uploads/2025/11/faq-1-1.jpg"
                                            alt="faq-1-1" title="faq-1-1">
                                    </div><!-- /.faq-section__thumb -->
                                </div><!-- /.col-lg-6 -->
                            </div><!-- /.row -->
                        </div><!-- /.container -->
                    </section><!-- /.faq-section -->
        ...
        <div class="elementor-element elementor-element-b31bbc1 e-con-full e-flex e-con e-parent" data-id="b31bbc1"
            data-element_type="container">
            <div class="elementor-element elementor-element-7fc0d7d elementor-widget elementor-widget-carit-client"
                data-id="7fc0d7d" data-element_type="widget" data-widget_type="carit-client.default">
                <div class="elementor-widget-container">
