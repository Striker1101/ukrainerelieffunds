...
@section('content')
        ...
        <div class="container">
            ...
            <ul class="carit-breadcrumb list-unstyled">
                ...
                <li class="post post-page current-item"><span property="itemListElement" typeof="ListItem"><span
                            property="name" class="post post-page current-item">About Us</span>
    ...
    <div data-elementor-type="wp-page" data-elementor-id="443" class="elementor elementor-443">
        <div class="elementor-element elementor-element-06223fb e-con-full e-flex e-con e-parent" data-id="06223fb"
            data-element_type="container">
            <div class="elementor-element elementor-element-1cc21de elementor-widget elementor-widget-carit-about-us"
                data-id="1cc21de" data-element_type="widget" data-widget_type="carit-about-us.default">
                            ...
                            <div class="row align-items-xl-end gutter-y-24">
                                <div class="col-lg-6">
                                    <div class="about-one__content">
                                        <div class="about-one__top">
                                            ...
                                            <p class="about-one__text bw-text bw-split-in-down">Helping others is a
                                                fundamental virtue that transcends cultures, religions, and philosophies. It
                                                is an intrinsic part of our humanity and a cornerstone of a compassionate
                                                and just society. When we lend a hand to those in need,</p>
                                            <!-- /.about-one__text -->
                                        </div><!-- /.about-one__top -->
                                ...
                                <div class="col-lg-6">
                                    <div class="about-one__list">
                                        <div class="about-one__list__item">
                                            <div class="about-one__item__round wow fadeInUp" data-wow-duration='1500ms'
                                                data-wow-delay='100ms'>
                                                <a href="{{ route('home') }}" class="about-one__img">
                                                    <img decoding="async"
									...
									"forceHeight": true
                                                        ...
                                                        <span class="lettering-item">RISE YOUR HANDS TION FOUNDATI NON
                                                            PROFIT CHARITY</span>
                                                    </div>
                                            ...
                                            <div class="about-one__item wow fadeInUp" data-wow-duration='1500ms'
                                                ...
                                                <div class="about-one__item__content">
                                                    <h4 class="about-one__item__title"><a
                                                            href="{{ route('donation') }}">Treatment
                                                            Help</a></h4><!-- /.about-one__item__title -->
                                                    <p class="about-one__item__text">Biggest Prayers Community</p>
                                        ...
                                        <div class="about-one__list__item wow fadeInUp" data-wow-duration='1500ms'
                                            ...
                                            <div class="about-one__btn">
                                                <a href="{{ route('donation') }}" class="carit-btn"><span></span>View All
                                                    More</a>
                                            </div><!-- /.about-one__item__btn -->
                                        </div><!-- /.about-one__list__item -->
                                    </div><!-- /.about-one__list -->
        ...
        <div class="elementor-element elementor-element-980f9c2 e-con-full e-flex e-con e-parent" data-id="980f9c2"
            data-element_type="container">
            <div class="elementor-element elementor-element-dd58c5a elementor-widget elementor-widget-carit-audio"
                data-id="dd58c5a" data-element_type="widget" data-widget_type="carit-audio.default">
                <div class="elementor-widget-container">

                    <section class="audio-one audio-one--two">
                        <div class="container">
                                            ...
                                            <div class="audio-one__carousel carit-owl__carousel owl-carousel"
                                                ...
                                                <div class="item">
													...
													"height": 40
                                                            ...
                                                            <h3 class="audio-one__item__title">we believe in the
                                                                transformative power of community.</h3>
                                                            ...
                                                            <div class="audio-one__item__bottom">
                                                                <div class="audio-one__item__auth">
                                                                    <div class="audio-one__item__auth__image">
                                                                        <img decoding="async"
                                                                            src="{{ asset('images/tes/tes2.jpg') }}"
                                                                            alt="music-auth-1-1" title="music-auth-1-1">
                                                                    </div><!-- /.audio-one__item__auth__image -->
                                                                    <div class="audio-one__item__auth__content">
                                                                        <h4 class="audio-one__item__auth__name">Church
                                                                            radio station</h4>
                                                                        <!-- /.audio-one__item__auth__name -->
                                                                        <p class="audio-one__item__auth__dec">Total audio
                                                                            250+</p><!-- /.audio-one__item__auth__dec -->
                                                                    </div><!-- /.audio-one__item__auth__content -->
                                                ...
                                                <div class="item">
													...
													"height": 40
                                                            ...
                                                            <h3 class="audio-one__item__title">We believe in the power of
                                                                community to create lasting change.</h3>
                                                            <!-- /.audio-one__item__title -->
                                                            <div class="audio-one__item__bottom">
                                                                <div class="audio-one__item__auth">
                                                                    <div class="audio-one__item__auth__image">
                                                                    ...
                                                                    <div class="audio-one__item__auth__content">
                                                                        ...
                                                                        <!-- /.audio-one__item__auth__name -->
                                                                        <p class="audio-one__item__auth__dec">Total audio
                                                                            359+</p><!-- /.audio-one__item__auth__dec -->
                                                                    </div><!-- /.audio-one__item__auth__content -->
                                                                </div><!-- /.audio-one__item__auth -->
                                                                <div class="audio-one__item__star">
                                                                    <i class="fas fa-star"></i><i
                                                ...
                                                <div class="item">
													...
													"height": 40
                                                            ...
                                                            <h3 class="audio-one__item__title">We trust in the ability of
                                                                communities to transform lives.</h3>
                                                            <!-- /.audio-one__item__title -->
                                                            <div class="audio-one__item__bottom">
                                                                <div class="audio-one__item__auth">
                                                                    <div class="audio-one__item__auth__image">
                                                                        <img decoding="async"
                                                                            src="{{ asset('images/tes/tes1.jpg') }}"
                                                                            alt="music-auth-1-1" title="music-auth-1-1">
                                                                    </div><!-- /.audio-one__item__auth__image -->
                                                                    <div class="audio-one__item__auth__content">
                                                                        <h4 class="audio-one__item__auth__name">Church
                                                                        ...
                                                                        <!-- /.audio-one__item__auth__name -->
                                                                        <p class="audio-one__item__auth__dec">Total audio
                                                                            653+</p><!-- /.audio-one__item__auth__dec -->
                                                                    </div><!-- /.audio-one__item__auth__content -->
                                                                </div><!-- /.audio-one__item__auth -->
                                                                <div class="audio-one__item__star">
                                                                    <i class="fas fa-star"></i><i
        ...
        <div class="elementor-element elementor-element-1c3ea2c e-con-full e-flex e-con e-parent" data-id="1c3ea2c"
            data-element_type="container">
            <div class="elementor-element elementor-element-88f9aab elementor-widget elementor-widget-carit-service"
                data-id="88f9aab" data-element_type="widget" data-widget_type="carit-service.default">
                <div class="elementor-widget-container">

                    <section class="service-two section-space service-two--three" id="services">
                        <div class="container">
                            <div class="service-two__top">
                                ...
                                <p class="service-two__top__text bw-text bw-split-in-down">Maecenas ornare iaculis
                                    ultricies. Maecenas eget tristique orci. Praesent imperdiet purus et sodales volutpat.
                                    Proin ultrices, massa eu pulvinar pulvinar.</p><!-- /.service-two__top__text -->
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                    <div class="service-two__card wow fadeInUp" data-wow-duration='1500ms'
                                        ...
                                        <div class="service-two__card__content">
                                            ...
                                            <p class="service-two__text">Support your chosen cause with a one-time
                                                donation.</p><!-- /.service-two__text -->
                                            <h4 class="service-two__title"><a href="#">Flexible
                                        ...
                                        <div class="service-two__thumb">
                                            <img decoding="async"
                                                ...
                                                alt="service-h-1-1" title="service-h-1-1"> <a href="#"
                                    ...
                                    <div class="service-two__card wow fadeInUp" data-wow-duration='1500ms'
                                        ...
                                        <div class="service-two__thumb">
                                            <img decoding="async"
                                                ...
                                                alt="service-h-1-2" title="service-h-1-2"> <a href="#"
                                                class="event-card__thumb__link"><i aria-hidden="true"
                                                    class="icon-hover"></i></a>
                                        </div><!-- /.service-two__thumb -->
                                        <div class="service-two__card__content">
                                            ...
                                            <p class="service-two__text">Launch your own crowdfunding campaigns.</p>
                                            <!-- /.service-two__text -->
                                            <h4 class="service-two__title"><a href="#">Personal
                                    ...
                                    <div class="service-two__card wow fadeInUp" data-wow-duration='1500ms'
                                        ...
                                        <div class="service-two__thumb">
                                            <img decoding="async"
                                                ...
                                                alt="service-h-1-4" title="service-h-1-4"> <a href="#"
                                                class="event-card__thumb__link"><i aria-hidden="true"
                                                    class="icon-hover"></i></a>
                                        </div><!-- /.service-two__thumb -->
                                        <div class="service-two__card__content">
                                            ...
                                            <p class="service-two__text">Launch your own crowdfunding campaigns.</p>
                                            <!-- /.service-two__text -->
                                            <h4 class="service-two__title"><a href="#">Endowment
        ...
        <div class="elementor-element elementor-element-54b25b9 e-con-full e-flex e-con e-parent" data-id="54b25b9"
            data-element_type="container">
            <div class="elementor-element elementor-element-0965ebe elementor-widget elementor-widget-carit-video"
                data-id="0965ebe" data-element_type="widget" data-widget_type="carit-video.default">
                <div class="elementor-widget-container">

                    <div class="video-one">
                        <div class="video-one__bg"
                            style="background-image: url(https://caritwp.bracketweb.com/wp-content/uploads/2025/11/video-bg.jpg);">
                        </div><!-- /.video-one__image -->
                        <div class="video-one__item-video">
                            <div class="video-one__item__btn__inner wb-hover-btn-wrapper">
                                <a class="video-popup wb-hover-btn-item wb-btn-circle"
                                    href="https://www.youtube.com/watch?v=GTn2EKD-cfg">
                                    <span>Play</span>
                                </a>
                            </div>
                        </div><!-- /.video-one__item__btn -->
                    </div><!-- /.video-one -->

                </div>
            </div>
        </div>
        <div class="elementor-element elementor-element-b13c55a e-con-full e-flex e-con e-parent" data-id="b13c55a"
            data-element_type="container">
            <div class="elementor-element elementor-element-9053169 elementor-widget elementor-widget-carit-testimonials"
                data-id="9053169" data-element_type="widget" data-widget_type="carit-testimonials.default">
                <div class="elementor-widget-container">
                            ...
                            <div class="testimonials-one__inner section-space-bottom">
                                <div class="testimonials-one__top">
                                    <div class="testimonials-one__round">
                                        <a href="{{ route('about') }}" class="testimonials-one__round__img">
                                            <img decoding="async"
                                        ...
                                        <div class="item">
                                            <div class="testimonials-one__item">
                                                <div class="testimonials-one__item__top">
                                                    <h2 class="testimonials-one__title">{{ $testimony['name'] }}</h2>
                                                ...
                                                <p class="testimonials-one__text">{{ $testimony['content'] }}</p>
                                                <!-- /.testimonials-one__text -->
                                                <div class="testimonials-one__auth">
                                                    <img decoding="async"
                                                        src="{{ asset('images/' . $testimony['image']) }}"
                                                ...
                                                <div class="testimonials-one__fram">
                                                    ...
                                                    <div class="testimonials-one__fram__tag">
                                                        <span>{{ $testimony['role'] }}</span>
                                                    </div><!-- /.testimonials-one__fram__tag -->
        ...
        <div class="elementor-element elementor-element-2b4af25 e-con-full e-flex e-con e-parent" data-id="2b4af25"
            data-element_type="container">
            <div class="elementor-element elementor-element-61bc099 elementor-widget elementor-widget-carit-blog"
                data-id="61bc099" data-element_type="widget" data-widget_type="carit-blog.default">
                <div class="elementor-widget-container">
                                ...
                                <div class="row align-items-end gutter-y-24">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="blog-one__right">
                                            <p class="blog-one__text bw-text bw-split-in-down">To donate is to wield the
                                                power of kindness, shaping a future that others thought impossible.</p>
                                            <!-- /.blog-one__text -->
                                    ...
                                    <div class="item">
                                        <div class="blog-card wow fadeInUp" data-wow-duration='1500ms'
                                            ...
                                            <div class="blog-card__image">
                                                ...
                                                <div class="blog-card__date">{{ $news['date'] }}</div>
                                                <!-- /.blog-card__date -->
        ...
        <div class="elementor-element elementor-element-4888057 e-con-full e-flex e-con e-parent" data-id="4888057"
            data-element_type="container">
            <div class="elementor-element elementor-element-d544619 elementor-widget elementor-widget-carit-client"
                data-id="d544619" data-element_type="widget" data-widget_type="carit-client.default">
                <div class="elementor-widget-container">
